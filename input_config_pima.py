...
model_name = 'ebm' # ebm, # catboost , 'xgboost', 'random_forest'
...
return_options = True # Whether to include answer options in the prompt (e.g., "0 = No, 1 = Yes") MedRAG Mixtral NO, Huggingface meditron YES, MedRAG LLama2 YES?
rag_K_documents = 10

# EVALUATOR
top_k = 3
metric_exp_ranking = 'rbo'
selector_name = 'simple'
# Average text y-shift for better visualization of the plot, specific to each LLM and RAG combination
...
epochs = 2000
n_samples_synthesizer = 5000
# n_synth = min(20000, max(3000, int(3 * n_test)))
